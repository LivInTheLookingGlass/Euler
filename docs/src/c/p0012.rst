...
- :cref:`\<stdio.h\> <io>`
- :cref:`\<stdlib.h\> <program>` (implicitly, via factors.h & if not compiled on PCC)
- :cref:`\<math.h\> <numeric/math>` (implicitly, via factors.h & if not compiled on PCC)
- :cref:`\<stdbool.h\> <types>` (implicitly, via factors.h)
